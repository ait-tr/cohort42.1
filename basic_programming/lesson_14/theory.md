...
`git branch -M <branch_name>` — создание основной ветки (обычно main или master)

`git remote add origin https://github.com/<profile_name>/<repo_name>` — связывание локального репозитория с удалённым

`git pull origin <branch_name>` — получение файлов удалённого репозитория
...
`git push -u origin <branch_name>` — синхронизация с удалённым репозиторием
