...
const filterByHW = playersWithGoals.filter(player => player.height >= 180 && player.weight < 80);

console.log(filterByHW);

console.log("=================================================");

const filterByGoals = playersWithGoals
.filter(player => player.goals > 0)
.sort((a, b) => b.goals - a.goals);

console.log(filterByGoals);
