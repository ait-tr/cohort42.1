...
console.log(footballPlayers.sort((a, b) => a.goals - b.goals));

// дополнительный уровень сложности сортировки
// const positionOrder = ["Defender", "Forward", "Midfielder", "Goalkeeper"];
